...
public interface PublishHighScoreEndpoint {
    ...
    /**
     *
     * Diese Operation dient zum Speichern eines WE Menschärgere Dich Nicht
     * Ergebnisses am WE Highscore Board
     *
     *
     * @param in
    ...
    public String publishHighScore(
            @WebParam(name = "HighScoreRequest", targetNamespace = "http://big.tuwien.ac.at/we/highscore/data", partName = "in") HighScoreRequestType in)
            throws Failure;
}
